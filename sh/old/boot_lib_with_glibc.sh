...
export FLAG="-fPIC -Wno-dev --warn-uninitialized"
...
COMPILER_BIN_FOLDER=$COMPILER_FOLDER/bin
    ...
    export FLAG="${FLAG} -nostdinc++ -isystem${COMPILER_FOLDER}/${TARGET_TRIPLE}/include/c++/v1 -isystem${COMPILER_FOLDER}/include -isystem${COMPILER_FOLDER}/include/c++/v1 -isystem/usr/include -I${ADDITIONAL_INCLUDE} "
    export COMMON="-G Ninja -DCMAKE_INSTALL_PREFIX=$INSTALL_DIR "
...
export GLIBC_SETTING=-DLLVM_LIBGCC_EXPLICIT_OPT_IN=Yes 
