...
export EMBEDDIG_LIB_SETTING="${USE_EXISTING_TABLEGEN} -DCMAKE_CROSSCOMPILING=True -DCMAKE_SYSTEM_NAME=Generic -DLLVM_INCLUDE_BENCHMARKS=OFF -DLLVM_INCLUDE_TOOLS=OFF ${COMPILER_RT_BAREMETAL_SETTING} -DHAVE_CXX_ATOMICS_WITHOUT_LIB=1 -DHAVE_CXX_ATOMICS64_WITHOUT_LIB=1 -DLLVM_INCLUDE_BENCHMARKS=OFF -DLLVM_INCLUDE_UTILS=OFF -DLLVM_INCLUDE_TESTS=OFF -DLLVM_INCLUDE_EXAMPLES=OFF  -DLLVM_INCLUDE_DOCS=OFF "
...
cmake ../llvm-project/${CMAKE_START_MODULE}  \
   ...
   ${EMBEDDIG_LIB_SETTING} ${RT_STANDALONE} 
