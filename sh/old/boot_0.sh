...
export BUILD_DIR=../${PROJECT}_0_build
export INSTALL_DIR=../install/${PROJECT}
#-DDEFAULT_SYSROOT=$INSTALL_DIR 
...
export LIBUNWIND_OFF_SETTING=" -DLLVM_ENABLE_SPHINX=ON -DLIBUNWIND_INCLUDE_DOCS=ON"  # pip install sphinx  
